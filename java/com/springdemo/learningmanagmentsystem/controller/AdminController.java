...
@SessionAttributes({"adminid","ausername","tusername"})
public class AdminController{ 
	...
	public String personalDetailsFormFill(AdminPersonalDetails ap, ModelMap model) {
	...
	public ModelAndView adminpersonalDetailsView(ModelMap model) {
		String user = (String) model.get("ausername");
