...
<title>TEACHER ACADEMIC VIEW PAGE</title>
	...
	<div class="container">
		<form action="teacher_update" method="post">
			...
			<h2 class="text-center colw">
				<strong>TEACHER ACADEMIC VIEW PAGE</strong>
			</h2>
			<div class="con-color">
					...
					<div class="row dis">
						<div class="col-4 mt-1 mb-1 ">
							<div class="form-group">
								<label class="clow" for="teacherId "><strong>Teacher ID</strong></label> <input
									type="text" class="form-control" id="teacherId"
									name="teacherId" value=${obj.teacherId } required>
							</div>
						</div>
						<div class="col-4 mt-1 mb-1 ">
							<div class="form-group">
								<label class="clow" for="tusername"><strong>Username</strong></label> <input
									type="text" class="form-control" name="tusername"
									id="tusername" value=${obj.tusername } required>
							</div>
						</div>
						<div class="col-4 mt-1 mb-1">
							<div class="form-group">
