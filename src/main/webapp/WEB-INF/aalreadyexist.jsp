...
%>
	...
	<div class="container">
		<div class="row">
			<h1 class="text">
				<strong><em>${ausername},Your Details already exists.<br><br>Click below button to view your previous data<br>
				<a type="button" class="btn btn-warning" href="/api/vi/adminview">VIEW PAGE</a></em></strong>
			</h1>
		</div>
	</div>
</body>
