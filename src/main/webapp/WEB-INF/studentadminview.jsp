...
<title>Student Admin View</title>
<link
	href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/css/bootstrap.min.css"
	rel="stylesheet"
	integrity="sha384-wEmeIV1mKuiNpC+IOBjI7aAzPcEZeedi5yW5f2yOq55WWLwNGmvvx4Um1vskeMj0"
...
%>
	...
	<div class="container clas">
		<h2>
			<strong>Student Details View</strong>
		</h2>
		<div class="top">
			<div class="container">
				<div class="tab">
					...
					<caption></caption>
						<thead>
							<tr>
								<th class="col1" scope="col">Reg No.</th>
								<th class="col1" scope="col">Username</th>
								<th class="col1" scope="col">Student Name</th>
								<th class="col1" scope="col">Gender</th>
								<th class="col1" scope="col">Date of Birth</th>
								<th class="col" scope="col">Degree<br></th>
								<th class="col" scope="col">Department<br></th>
								<th class="col" scope="col">Course Type<br></th>
