...
<title>Student Assigned to Teacher View</title>
<link
...
%>
	...
	<div class="container clas">
		<h2>
			<strong>Student Assigned View</strong>
		</h2>
		<div class="top">
			<div class="container">
				<div class="row dis">
					...
					<div class="col-6">
						<label for="exampleFormControlInput1" class="form-label"><strong>Teacher ID</strong> ${sp.teacherId}</label>
					</div>
				</div>
				<div class="row dis">
					<div class="col-6">
