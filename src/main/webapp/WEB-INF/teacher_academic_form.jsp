...
<title>TEACHER ACADEMIC FORM PAGE</title>
	...
	<div class="container">
		<form action="teacher" method="post">
			...
			<h2 class="text-center colw">
				<strong>TEACHER ACADEMIC FORM PAGE</strong>
			</h2>
			<div class="con-color">
						...
						<div class="col-4 mt-1 mb-1 ">
							<div class="form-group">
								<label class="clow" for="teacherId"><strong>Teacher ID</strong></label> <input
									...
									name="teacherId" placeholder="Teacher Id" required>
							</div>
						</div>
						<div class="col-4 mt-1 mb-1 ">
							<div class="form-group">
								<label class="clow" for="tusername"><strong>Username</strong></label> <input
									type="text" class="form-control" name="tusername" id="username"
									value=${tusername } required>
							</div>
						</div>
						<div class="col-4 mt-1 mb-1">
							<div class="form-group">
						...
						<div class="col-4">
							<div class="form-group">
								<label class="clow" for="lastname"><strong>Last Name</strong></label> <input
									type="text" class="form-control" name="lastname" id="lastname" placeholder="Lastname"
									required>
							</div>
							...
							<div class="col-6">
								<div class="form-group dis">
									<label class="addres" for="address1"><strong>Address
										...
										id="address1" name="address1" placeholder="House Number" required>
								</div>
							</div>
							<div class="col-6">
								<div class="form-group dis">
									<label class="addres" for="address2"><strong>Address
										...
										id="address2" name="address2" placeholder="Street or Locality" required>
								</div>
							</div>
						</div>
							...
							<div class="col-4 ">
								<div class="form-group">
									<label class="addres" for="city"><strong>City</strong></label> <input
										type="text" class="form-control" id="city" name="city" placeholder="City"
										required>
								</div>
							...
							<div class="col-4">
								<div class="form-group">
									<label class="addres" for="zipcode"><strong>Zip Code</strong></label> <input
										...
										maxlength="6" placeholder="Zipcode" required>
								</div>
							</div>
						</div>
					</div>
