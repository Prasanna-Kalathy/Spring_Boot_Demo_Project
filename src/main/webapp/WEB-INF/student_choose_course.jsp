...
<title>Course Selection by Student</title>
	...
	<div class="container clas">
		...
		<div class="top">
			<div class="container">
					...
					<div class="row dis">
						<div class="col-6">
							<label for="exampleFormControlInput1"
								value=${firstname}${middlename}${lastname} class="form-label"><strong>Name:</strong>${sp.firstname}
								${sp.middlename} ${sp.lastname}</label>
						</div>
						<div class="col-6">
							<label for="exampleFormControlInput1" value=${regno }
								class="form-label"><strong>Registration No.: </strong>${sp.regno}</label>
						</div>
					</div>
					<div class="row dis">
						<div class="col-6">
				...
				<form action="cour_add">
					<div class="row tab">
						<div class="col-4 ">
							<label class="clow" for="fname ">CHOOSE YOUR COURSE</label>
						</div>
						...
						<div class="col-4 ">
							<select class="form-select" name="courseName"
								...
								<c:forEach items="${list}" var="curt">
									<option value=${ curt.courseName}>${curt.courseName}</option>
									<a type="button" class="btn btn-success" href="cour_add">Update</a>
								</c:forEach>
