	...
	<div class="container">
		<div class="cola-3">
			...
			<table class="tr">
				...
				<th id="tl"></th>
				<tr>
					<td class="trd"><a href="/api/vi/student"><strong>ADD
								ACADEMIC DETAILS</strong></a></td>
				</tr>
				<tr>
					<td class="trd"><a href="/api/vi/studentview"><strong>VIEW
								AND UPDATE ACADEMIC DETAILS VIEW</strong></a></td>
				</tr>
				<tr>
					<td class="trd"><a href="/api/vi/student_cour_add"><strong>COURSES
								SELECTION</strong></a></td>
				</tr>
				<tr>
					<td class="trd"><a href="/api/vi/student_cour_view"><strong>COURSES
								ASSIGNED</strong></a></td>
				</tr>
				<tr>
					<td class="trd"><a href="/api/vi/student_teacher_assigned"><strong>TEACHER
								ASSIGNED</strong></a></td>
				</tr>
				<tr>
					<td class="trd"><a href="/api/vi/student_marks"><strong>MARKS
								VIEW</strong></a></td>
				</tr>
			</table>
		</div>
