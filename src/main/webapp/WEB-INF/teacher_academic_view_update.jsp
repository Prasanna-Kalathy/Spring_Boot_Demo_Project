...
%>
	...
	<div class="container">
		<form action="teacher_update">
			<h2 class="text-center colw">TEACHER ACADEMIC VIEW PAGE</h2>
			<div class="con-color">
				<table>
					<caption></caption>
					<th id="tl"></th>
					...
					<div class="cen">
						<a type="button" class="btn btn-outline-warning mb-3"
							href="/api/vi/teacher_update?id=${obj.id}"><strong>UPDATE</strong></a>
					</div>
				</table>
			</div>
		</form>
