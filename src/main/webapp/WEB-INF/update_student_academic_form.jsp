	...
	<div class="container">
		<form action="student_update" method="post">
			...
			<h2 class="text-center colw">
				<strongb>STUDENT ACADEMIC FORM PAGE</strong>
			</h2>
			<div class="con-color">
				...
				<th id="tl"></th>
						...
						<div class="col-4 mt-1 mb-1 ">
							<div class="form-group">
								<label class="clow" for="regno "><strong>Registration
									...
									name="regno" value=${obj.regno } required>
							</div>
						</div>
						<div class="col-4 mt-1 mb-1 ">
							<div class="form-group">
								<label class="clow" for="username"><strong>Username</strong></label> <input
					...
					<div class="row dis">
						<div class="col-4 ">
							<div class="form-group">
								<label class="clow" for="firstname"><strong>First Name</strong></label> <input
									type="text" class="form-control" name="firstname"
									id="firstname" value=${obj.firstname } required>
							</div>

						</div>
						<div class="col-4">
							<div class="form-group">
								<label class="clow" for="middlename"><strong>Middle Name</strong></label>
								<input type="text" class="form-control" name="middlename"
									id="middlename" value=${obj.middlename } required>
							</div>

						</div>
						<div class="col-4">
							<div class="form-group">
								<label class="clow" for="lastname"><strong>Last Name</strong></label> <input
									type="text" class="form-control" name="lastname" id="lastname"
									value=${obj.lastname } required>
							</div>
					...
					<div class="row dis">
						<div class="col-4 pb-3 pt-1 mt-1 mb-1">
							<label class="clow" for="dateOfBirth"><strong>Date of
									Birth</strong></label>
							<div class="input-group date" data-provide="datepicker">
								<input type="date" class="form-control" name="dateOfBirth"
									value=${obj.dateOfBirth } required>
					...
					<div class="row dis">
						<div class="col-4 mt-1 mb-1 ">
							<div class="form-group">
								<label class="clow" for="degree"><strong>Degree</strong></label> <input
									type="text" class="form-control" id="degree" name="degree"
									placeholder="degree" value=${obj.degree } required>
							</div>
						</div>
						<div class="col-4 mt-1 mb-1">
							<div class="form-group">
								<label class="clow" for="department"><strong>Department</strong></label> <input
									type="text" class="form-control" id="department"
									name="department" placeholder="department"
									value=${obj.department } required>
							</div>
						</div>
						<div class="col-4 mt-1 mb-1">
							<div class="form-group">
								<label class="clow" for="coursetype"><strong>Course Type</strong></label>
								<select class="form-select" name="coursetype"
									aria-label="Default select example" value=${obj.coursetype }
									required>
					...
					<div class="container con-col">
							...
							<div class="col-6">
								<div class="form-group dis">
									<label class="addres" for="address1"><strong>Address
										...
										id="address1" name="address1" value=${obj.address1 } required>
								</div>
							</div>
							<div class="col-6">
								<div class="form-group dis">
									<label class="addres" for="address2"><strong>Address
										...
										id="address2" name="address2" value=${obj.address2 } required>
								</div>
							</div>
						</div>
						<div class="row dis pb-3">
							<div class="col-4 ">
								<div class="form-group">
									<label class="addres" for="city"><strong>City</strong></label> <input
										type="text" class="form-control" id="city" name="city"
										value=${obj.city } required>
								</div>

							</div>
							<div class="col-4">
								<div class="form-group">
									<label class="addres" for="state"><strong>State</strong></label> <input
										type="text" class="form-control" id="state" name="state"
										value=${obj.state } required>
								</div>

							</div>
							<div class="col-4">
								<div class="form-group">
									<label class="addres" for="zipcode"><strong>Zip Code</strong></label> <input
										type="number" class="form-control" id="zipcode" name="zipcode"
										value=${obj.zipcode } maxlength="6" required>
								</div>
							</div>
						</div>
					</div>
